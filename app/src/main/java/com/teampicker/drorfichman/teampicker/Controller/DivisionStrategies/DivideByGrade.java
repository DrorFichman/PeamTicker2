...
public class DivideByGrade implements IDivider {
    ...
    public void divide(Context ctx, @NonNull ArrayList<Player> comingPlayers,
        ...
        OptionalDivision selected = getDivision(Others, GKs, Defenders, Playmakers, Divs);
        for (int option = 0; option < OPTIONS; ++option) {
            OptionalDivision another = getDivision(Others, GKs, Defenders, Playmakers, Divs);
    ...
    private static OptionalDivision getDivision(ArrayList<Player> iOthers,
